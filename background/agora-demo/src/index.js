...
$(() => {
  ...
  if (options.appid && options.channel) {
    ...
    $("#vectorly-token").val(options.vectorlyToken);
...
async function join() {
  ...
  try{
    ...
    const filter = new BackgroundFilter(localTracks.videoTrack._mediaStreamTrack, {token: document.getElementById("vectorly-token").value,  model: 'webgl',    analyticsEnabled: false,});
