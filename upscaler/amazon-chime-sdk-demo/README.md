## Vectorly Upscaler <> Amazon Chime Integration

This demo shows how to use the Vectorly Upscaler within Amazon Chime's Video Processor SDK
...
Beyond having an [AWS account and credentials](https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html), you'll need a Vectorly token which you can get [in the Vectorly Dashboard](https://ai-filters.vectorly.io/)

Once you have it, you can then set your Vectorly token in line 55 of `app/meetingV2/videoFilter/VectorlyUpscalerProcessor.ts`
